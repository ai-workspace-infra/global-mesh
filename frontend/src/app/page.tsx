  ...
  return (
    <div className="xds min-h-screen bg-slate-50 dark:bg-[#0b0f19] text-slate-900 dark:text-slate-100 antialiased">
      <header className="border-b border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-900/70 backdrop-blur sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between text-sm">
          <div className="flex items-center gap-2.5 font-bold">
            <span className="w-3 h-3 rounded-full bg-blue-600 animate-pulse" />
            <span>Global Mesh</span>
            <span className="text-xs font-mono px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 dark:bg-blue-950 dark:text-blue-300 border border-blue-200 dark:border-blue-800">Zero-Trust OOB</span>
          </div>
          <div className="flex items-center gap-4 text-xs text-slate-600 dark:text-slate-400">
            <a href="https://console.onwalk.net/products/global-mesh" className="hover:text-blue-600 transition">UAT</a>
            <a href="https://console.svc.plus/products/global-mesh" className="hover:text-blue-600 transition">PROD</a>
            <a href="https://github.com/ai-workspace-infra/global-mesh" className="hover:text-blue-600 transition">GitHub</a>
          </div>
        </div>
      </header>
      ...
      <footer className="border-t border-slate-200 dark:border-slate-800 py-8 text-center text-xs text-slate-500">
        <div className="max-w-6xl mx-auto px-4 space-y-2">
          <p>Global Mesh · 一朵不是云的虚拟云 · 全球多云去中心化带外管理专网</p>
          <p className="font-mono text-[11px] text-slate-400">Linode · Hetzner · UCloud · Contabo · Vultr · 0 Inbound Ports</p>
        </div>
      </footer>
    </div>
  );
